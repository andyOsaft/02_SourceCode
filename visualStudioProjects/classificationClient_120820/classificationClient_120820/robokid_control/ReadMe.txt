========================================================================
    ANWENDUNG: robokid_control-Projektübersicht
========================================================================

Diese robokid_control-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre robokid_control-Anwendung besteht.

robokid_control.vcxproj
...
robokid_control.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "robokid_control.pch und eine 
