...
/**
 * task. h
 * <pre>void vTaskDelay( uint32_t xTicksToDelay );</pre>
 *
 ...
 * Example usage:
 ...
 {
 // Block for 500ms.
 const uint32_t xDelay = 500 / portTICK_RATE_MS;
 ...
 * \ingroup TaskCtrl
 */
//void vTaskDelay( uint32_t xTicksToDelay ) PRIVILEGED_FUNCTION;
void vTaskDelay( uint16_t xTicksToDelay );
/**
 * task. h
 * <pre>void vTaskDelayUntil( uint32_t *pxPreviousWakeTime, uint32_t xTimeIncrement );</pre>
 *
 ...
 * \ingroup TaskCtrl
 */
void vTaskDelayUntil( uint16_t * const pxPreviousWakeTime, uint16_t xTimeIncrement ) PRIVILEGED_FUNCTION;
...
/**
 * task. h
 * <PRE>uint32_t xTaskGetTickCount( void );</PRE>
 *
 ...
 * \ingroup TaskUtils
 */
uint16_t xTaskGetTickCount( void ) PRIVILEGED_FUNCTION;
 ...
 * \ingroup TaskUtils
 */
uint16_t xTaskGetTickCountFromISR( void ) PRIVILEGED_FUNCTION;
 ...
 * period.
 */
void vTaskPlaceOnEventList( const xList * const pxEventList, uint16_t xTicksToWait ) PRIVILEGED_FUNCTION;
 ...
 */
void vTaskPlaceOnEventListRestricted( const xList * const pxEventList, uint32_t xTicksToWait ) PRIVILEGED_FUNCTION;
 ...
 * timeout has expired.
 */
portBASE_TYPE xTaskCheckForTimeOut( xTimeOutType * const pxTimeOut, uint16_t * const pxTicksToWait ) PRIVILEGED_FUNCTION;
 ...
 */
void vTaskStepTick( uint32_t xTicksToJump );
