...
const char digits_24px_data[] PROGMEM = {
...
const struct font_info digits_24px PROGMEM = {0xAC+(0x05<<8),0x13,0x18,0x25,0xBE,digits_24px_data,(char*)digits_24px_data+0xBE -0x25+1};
