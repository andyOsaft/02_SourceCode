...
#define mainSYSTEMSTATUS_TASK_PRIORITY ( tskIDLE_PRIORITY + 1 )
#define mainUSERINTERFACE_TASK_PRIORITY ( tskIDLE_PRIORITY + 2 )
#define mainSYSTEMCONTROL_TASK_PRIORITY ( tskIDLE_PRIORITY + 3 )
...
//{
    ...
    //{
        ...
        //{
            //lcd_moveto_xy  ( i, j );
            //lcd_put_string_P( FONT_DIGITS_24, NORMAL, PSTR("a"));
            //_delay_ms(30);
        //}
    //}
//}
...
//
		...
		//ulDummyVariable *= 3;
		//
		////prvCheckOtherTasksAreStillRunning2();
	//}
//}
/*-----------------------------------------------------------*/
