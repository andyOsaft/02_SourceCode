...
------ = --------  --->    x V = -----------------------
 ...
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 Falsche Umrechnung (Andy, 04.11.2012)
 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ->  Zuerst die gemessene Spannung auf die Realspannung umrechnen, d.h. / Referenzspannung (5V)
 
 ->  Dann über die Spannungsteilerformel die Spannung auf die Realspannung (>5V) umrechnen.
