...
#define TWI_TWBR            0x20//0x0C        // TWI Bit rate Register setting.
                                        // See Application note for detailed 
                                        // information on setting this value. (page 4/5)
										// 0x0c -> scl frequency = 200kHz @ 8MHz cpu clock
...
extern TWI_statusRegister TWI_statusReg;
