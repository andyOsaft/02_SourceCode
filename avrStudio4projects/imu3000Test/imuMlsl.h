...
typedef tMLError (*tWriteBurst)(unsigned char slaveAddr, unsigned char registerAddr, unsigned short length, const unsigned char *data);
typedef tMLError (*tReadBurst)(unsigned char slaveAddr, unsigned char registerAddr, unsigned short length, unsigned char *data);
