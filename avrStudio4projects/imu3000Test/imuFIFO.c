...
tMLError IMUgetAngularVelocityWorld(long *data)
{
        ...
        // TODO obviously a bug here, quat is defined with length 4
...
void quaternionToRotationMatrix(const long *quat, long *rot)
{
        // TODO uncomment
        /*
        rot[0] = (long) (((long long) quat[1] * quat[1] + (long long) quat[0] * quat[0]) / 536870912L - 1073741824L);
        rot[1] = (long) (((long long) quat[1] * quat[2] - (long long) quat[3] * quat[0]) / 536870912L);
        rot[2] = (long) (((long long) quat[1] * quat[3] + (long long) quat[2] * quat[0]) / 536870912L);
        rot[3] = (long) (((long long) quat[1] * quat[2] + (long long) quat[3] * quat[0]) / 536870912L);
        rot[4] = (long) (((long long) quat[2] * quat[2] + (long long) quat[0] * quat[0]) / 536870912L - 1073741824L);
