...
unsigned char mpuRegister[1];//NUM_OF_MPU_REGISTERS];
unsigned char mpuRegisterValid[1];//NUM_OF_MPU_REGISTERS];

/*---- keep shadow copy of all AUX registers ----*/
#define NUM_OF_AUX_REGISTERS 1 //65
unsigned char auxRegister[NUM_OF_AUX_REGISTERS];
unsigned char auxRegisterValid[NUM_OF_AUX_REGISTERS];

#define NUM_OF_KIONIX_REGISTERS 1  //96
unsigned char kionixRegister[NUM_OF_KIONIX_REGISTERS];
unsigned char kionixRegisterValid[NUM_OF_KIONIX_REGISTERS];
...
/**
 * @internal
 * @brief   MLSLCfgSamplingMPU configures the sampling method on the MPU.  
