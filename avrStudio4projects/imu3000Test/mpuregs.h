...
typedef enum
{
        ...
        MPUREG_08_RSVD,                    /* 08 0x08 MPUMEM_RAM_BANK_0 = 0, MPUMEM_RAM_BANK_1, MPUMEM_RAM_BANK_2,MPUMEM_RAM_BANK_3 */
        ...
        MPUREG_28_RSVD,                    /* 40 0x28 MPUMEM_RAM_BANK_0 = 0, MPUMEM_RAM_BANK_1, MPUMEM_RAM_BANK_2, MPUMEM_RAM_BANK_3 */
...
}       tMPUUserRegisters, MPU_USER_REGISTERS;
