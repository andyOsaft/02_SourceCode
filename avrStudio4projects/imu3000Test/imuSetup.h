...
typedef struct
{
        ...
        // A function or bitwise OR of functions that determine how the gyroscope bias will be automatically updated.
        ...
        unsigned short biasUpdateFunc;

        // Allows a user to register which orientations will trigger the user defined callback function.
        ...
        unsigned short orientationMask;

        // Callback function that triggers when raw data is acquired by the sensor driver.
        void (*rawDataCallback)(void);

        // Callback function that triggers when all the processing has been finished by the motion processing engines.
        void (*processedDataCallback)(void);
        ...
        void (*motionCallback)(unsigned short motionState);
